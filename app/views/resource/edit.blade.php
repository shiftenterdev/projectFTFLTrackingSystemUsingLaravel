...
<div id="content">
    ...
    <div id="breadcrumb">
        ...
        <a href="/edit" class="current">Edit Resource</a>
    </div>
            ...
            <div class="col-xs-12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        ...
                        {{ Form::model($item, array('method' => 'PATCH',
                        'route' =>array('resource.update', $item->id),'class'=>'form-horizontal')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <input type="text" name="user_id" placeholder="{{$item->user_id}}" >
                            </div>
                        </div>  <!--user id---->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-10">
                                <textarea name="summary" placeholder="{{$item->summary}}"></textarea>
                            </div>
                        </div>  <!--summary---->
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-1">
                                ...
                                <a href="/resource_option" class="btn btn-danger">Cancel</a>
